      ...
      <div class="card m-auto p-2">
        <div class="card-body">
          <form name="login-form" class="login-form" action="home.php" method="post" onsubmit="return validateCredentials();">
            <div class="logo">
        			<img src="images/prof.jpg" class="profile" style="height:50px; width:50px;"/>
        			<h1 class="logo-caption"><span class="tweak">C</span>hipfix A<span class="tweak">dmin L</span>ogin</h1>
        		</div> <!-- logo class -->
