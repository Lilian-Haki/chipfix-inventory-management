    ...
    <div class="container-fluid">
      <div class="container">
        ...
        <div class="row">
          ...
          <div class="col col-xs-4 col-sm-4 col-md-4 col-lg-4" style="padding: 7px 0; margin-left: 15px;border:#584faf;">
        ...
        <hr style="border-top: 2px solid #2E2CC2;">
        ...
        <div class="row">
          ...
          <?php
            ...
            createSection2('shopping-bag', 'add_medicine.php', 'Add New Products');
        ...
        <hr style="border-top: 2px solid #527AFF;">
